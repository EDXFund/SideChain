...
import (
	...
	"github.com/EDXFund/SideChain/internal/build"
	"github.com/EDXFund/SideChain/params"
	sv "github.com/EDXFund/SideChain/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/EDXFund/SideChain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/EDXFund/SideChain/mobile")
