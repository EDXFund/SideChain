...
import (
	...
	"github.com/MDCFund/SideChain/internal/build"
	"github.com/MDCFund/SideChain/params"
	sv "github.com/MDCFund/SideChain/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/MDCFund/SideChain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/MDCFund/SideChain/mobile")
